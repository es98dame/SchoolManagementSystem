...
class Apply extends CI_Controller
{
    ...
    function common_layout($data = '')
    {
        if (isset($data)) {
            ...
            $layout_data['navigation'] = $this->load->view('common/navigation',array("navi_seq"=>"apply"), true);
    ...
    {
        $this->Param['breadcrumb'] = array('HOME' => site_url("/"),'APPLY' => null,'APPLICATION' =>null);
        $contents_data['breadcrumb'] = $this->load->view('common/breadcrumb',$this->Param,true);

        $contents_data['contents'] = $this->load->view('apply/application',$this->Param,true);
    ...
    function download($mode='list')
    {
        ...
        $this->Param['breadcrumb'] = array('HOME' => site_url("/"),'APPLY' => null,'DOWNLOAD' =>null);
        $contents_data['breadcrumb'] = $this->load->view('common/breadcrumb',$this->Param,true);
    ...
    {
        $this->Param['breadcrumb'] = array('HOME' => site_url("/"),'APPLY' => null,'APPLICATION INFORMATION' =>null);
        $contents_data['breadcrumb'] = $this->load->view('common/breadcrumb',$this->Param,true);

        $contents_data['contents'] = $this->load->view('apply/applicationinfo',$this->Param,true);
        $layout_data = $this->common_layout($contents_data);
        $this->load->view('layouts/layout_sub',$layout_data,false);
    }
    function visa()
    {
        $this->Param['breadcrumb'] = array('HOME' => site_url("/"),'APPLY' => null,'VISA INFORMATION' =>null);
        $contents_data['breadcrumb'] = $this->load->view('common/breadcrumb',$this->Param,true);
        $contents_data['contents'] = $this->load->view('apply/visa',$this->Param,true);

        $layout_data = $this->common_layout($contents_data);
        $this->load->view('layouts/layout_sub',$layout_data,false);
    }

    function applycitizen(){

        $this->load->view('apply/applycitizen',$this->Param,false);
    }
