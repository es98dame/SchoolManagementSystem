...
<script>
    ...
    teachergrid.getCombo(0).put('1', "Administrator");
    ...
    myDataProcessor.defineAction("inserted",function(response){
        ...
        teachergrid.updateFromXML("administrators/getAdministrators?unqueId="+(new Date()).valueOf());
        return true;
    });
    ...
    function loadAdministrators(){
        ...
        teachergrid.clearAndLoad("administrators/getAdministrators?unqueId="+(new Date()).valueOf()+ oparams,function(){
