...
<div id="grade_container" style="padding: 1px 1px 1px 1px; width:900px; height:100%; overflow-x: auto; overflow-y: auto;">
    <div id="gradebox" style="padding: 0px 0px 0px 0px; width:100%;height:100%; background-color:white;overflow:hidden">
        ...
        <table class="formtable" cellspacing="0">
            <tr><td colspan="2"><?php echo $gpname;?> / <?php echo $classname;?> ( Remediation Class )<div style="float:right;"><input type="button" onclick="dhxLayout.cells('a').collapse();window.print();dhxLayout.cells('a').expand();" id="printButton" class="PrintButton" value="Print Page" /></div></td></tr>
            <tr><td colspan="2"><b><?php echo $stname;?></b></td></tr>
            <tr>
                <td style="padding:6px;line-height:130%" colspan="2">
                    Totals: <b style='color:#'>P</b> = <?php echo $sump;?>&nbsp;<span style='color:rgb(128,128,128);'>|</span>&nbsp;<b style='color:#'>T</b> = <?php echo $sumt;?>	&nbsp;<span style='color:rgb(128,128,128);'>|</span>&nbsp;<b style='color:#'>A</b> = <?php echo $suma;?>	</td>
            </tr>
        </table>
        <?php
        $yyy = array();
