...
<script>
    ...
    function loadAttendance(){
        ...
        assigngrid.clearAndLoad("<?php echo $_SERVER["PHP_SELF"];?>/getRAttendance?unqueId="+(new Date()).valueOf()+ oparams+"&sday=" +sday,function(){
    ...
    var	dpatten = new dataProcessor("<?php echo $_SERVER["PHP_SELF"];?>/setRAttendance?unqueId="+(new Date()).valueOf()); //lock feed url
