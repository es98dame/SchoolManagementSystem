...
<script>
    ...
    discgrid.setColTypes("ro,ro,ro,ro");
    ...
    function loadClassStudents(){
        ...
        discgrid.clearAndLoad("<?php echo $_SERVER["PHP_SELF"];?>/getRClassStudents?unqueId="+(new Date()).valueOf()+ oparams,function(){
    ...
    function loadStudent(s){
        ...
        if(s==1){
            studentgrid.clearAndLoad("<?php echo $_SERVER["PHP_SELF"];?>/getRSchoolRoster?vseach="+vsearch.value+"&unqueId="+(new Date()).valueOf()+ oparams,function(){
                //dhxLayout.cells("c").progressOff();
            });
        }else{
            studentgrid.updateFromXML("<?php echo $_SERVER["PHP_SELF"];?>/getRSchoolRoster?vseach="+vsearch.value+"&unqueId="+(new Date()).valueOf() + oparams);
            //dhxLayout.cells("c").progressOff();
        }
    }
    ...
    function loadRoster(s){
        ...
        if(s==1){
            rostergrid.clearAndLoad("<?php echo $_SERVER["PHP_SELF"];?>/getRClassRoster?unqueId="+(new Date()).valueOf()+ oparams,function(){
                //dhxLayout.cells("d").progressOff();
            });
        }else{
            rostergrid.updateFromXML("<?php echo $_SERVER["PHP_SELF"];?>/getRClassRoster?unqueId="+(new Date()).valueOf() + oparams);
            //dhxLayout.cells("d").progressOff();
        }
    }
    ...
    //============================================================================================
    var	dpForm = new dataProcessor("<?php echo $_SERVER["PHP_SELF"];?>/setRClassRoster?unqueId="+(new Date()).valueOf()); //lock feed url
