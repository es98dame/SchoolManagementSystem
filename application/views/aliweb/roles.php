...
<script>
    ...
    filesgrid.setHeader("id,name,roleorder,resource");
    filesgrid.setColumnIds("id,name,roleorder,resource");
    filesgrid.setInitWidths("30,200,60,60");
    filesgrid.enableAutoWidth(true);
    filesgrid.setColAlign("center,left,center,center");
    filesgrid.setColTypes("ro,ed,ed,link");
    filesgrid.setColSorting("int,str,int,str");
    ...
    myfamilyMenu.loadStruct("roles/menucontextRoles?unqueId="+(new Date()).valueOf());
    ...
    function loadFiles(){
        ...
        filesgrid.clearAndLoad("roles/getRoles?unqueId="+(new Date()).valueOf()+ oparams,function(){
            //loadclassall(gno);
            //loadstudentid();
        });
    }

    var	myDataProcessor = new dataProcessor("roles/setRoles?unqueId="+(new Date()).valueOf());
    ...
    myDataProcessor.defineAction("updated",function(response){
        ...
        filesgrid.updateFromXML("roles/getRoles?unqueId="+(new Date()).valueOf());
        return true;
    });
