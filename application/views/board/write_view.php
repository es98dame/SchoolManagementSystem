...
<?php 
echo form_open_multipart('apply/'.$tb_id.'/insert');
...
echo form_hidden('upload_check', 'true'); ?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input(array('name'=>'wr_name','class'=>'form-control','maxlength'=>'20','size'=>'15','required'=>'required'), $this->session->userdata('ALISESS_USERNAME')); ?>
                    </div>
	...
	<?php
        if($tb_id=="gallery"){
            echo '<button type="button" class="btn btn-primary" onclick="self.location.href=\'./glist\';">List</button>';

        }else{
            echo '<button type="button" class="btn btn-primary" onclick="self.location.href=\'./\';">List</button>';
        }
    ?>
            </div>
