...
<script>
    ...
    grid_classgrid.setHeader("Year,Trimester,Class,Instructor,Grade,Attendance,Overall Grade Average,Overall Attendance Average",null,["text-align:center;","text-align:center;","text-align:center;","text-align:center;","text-align:center;","text-align:center;"]);
    grid_classgrid.setColumnIds("schoolyear,trimester,classname,teachername,grade,attendance,allgrade,allattendance");
    grid_classgrid.setInitWidths("60,60,120,120,80,120,80,120");
    grid_classgrid.enableAutoWidth(true);
    grid_classgrid.setColAlign("center,center,center,center,center,center,center,center");
    grid_classgrid.setColTypes("ro,ro,link,ro,ro,ro,ro,ro");
    grid_classgrid.setColSorting("str,str,str,str,str,str,str,str");
