<div class="container">
    <div class="page-header col-xs-12 col-md-6 col-md-offset-4">
        <h1>Login <small>for students</small></h1>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6 col-md-offset-4">
            ...
            <div class="form-group">
                ...
                <?=anchor('/student/lost?grp=6','Lost Password?',array('class'=>'form-control btn btn-default','style' => 'width:120px;color:#0080FF;'))?>
            </div>

            <?php echo form_hidden('grp', '6');?>
            <?php echo form_close(); ?>
